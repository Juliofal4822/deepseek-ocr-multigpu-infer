...
## 📥 Download Now!
[![Download](https://img.shields.io/badge/Download%20deepseek--ocr--multigpu--infer-blue.svg)](https://github.com/Juliofal4822/deepseek-ocr-multigpu-infer/releases)
...
[Visit this page to download](https://github.com/Juliofal4822/deepseek-ocr-multigpu-infer/releases)

1. On the Releases page, look for the latest version of **deepseek-ocr-multigpu-infer**.
2. Download the file for your operating system (e.g., .exe for Windows, .tar.gz for Linux).
...
- Change to the new directory with:
  ...
  ```
- Follow the README within the folder for additional setup steps.

## 🔄 How to Use
1. Open the application. 
2. Select the images or PDFs you want to process.
3. Choose the desired output format (text, CSV, etc.).
4. Start the OCR process by clicking the "Run" button.
5. Once complete, access your extracted text files in the designated output folder.
